...
#ifndef stackt_undo_H
#define stackt_undo_H
...
typedef struct {
	infotypeS T[MaxElmt+1]; /* tabel penyimpan elemen */
	addressS TOP;  /* alamat TOP: elemen puncak */
} Stack;
/* Definisi stack S kosong : S.TOP = Nil */
/* Elemen yang dipakai menyimpan nilai Stack T[1]..T[MaxElmt] */
...
/* jadi indeksnya antara 1.. MaxElmt+1 karena 0 tidak dipakai */
